...
class HTML2Text(HTMLParser.HTMLParser):
    ...
    def o(self, data, puredata=0, force=0):
        ...
        if not self.quiet:
            ...
            if not NEVER_ADD_APPEND_LINKS and (self.a and ((self.p_p == 2 and self.links_each_paragraph) or force == "end")):
